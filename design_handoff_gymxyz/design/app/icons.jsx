/* ============================================================
   GymXYZ — Icon component (Lucide-style line icons)
   <Icon name size /> — stroke inherits currentColor, matching
   the TechXYZ iconography rules (line, ~1.8px, 24 grid).
   ============================================================ */
const GX_ICON_PATHS = {
...
function Icon({ name, size = 18, style, ...rest }) {
  const inner = GX_ICON_PATHS[name] || '';
...
/* GymXYZ default mark — kettlebell flanked by accent dumbbell plates.
   Plates use the themed accent; body uses currentColor (ink). */
function KettlebellMark({ size = 38 }) {
  return React.createElement('svg', {
    width: size, height: size, viewBox: '0 0 24 24', fill: 'none',
  }, React.createElement('g', { fill: 'var(--color-brand)' },
      React.createElement('rect', { x: 1, y: 9, width: 3.4, height: 10, rx: 1.4 }),
      React.createElement('rect', { x: 4.7, y: 11.6, width: 2.8, height: 4.8, rx: 1.1 }),
      React.createElement('rect', { x: 19.6, y: 9, width: 3.4, height: 10, rx: 1.4 }),
      React.createElement('rect', { x: 16.5, y: 11.6, width: 2.8, height: 4.8, rx: 1.1 }),
    ),
    React.createElement('path', { fill: 'currentColor', d: 'M8.6 9.2a3.4 3.4 0 0 1 6.8 0h-1.8a1.6 1.6 0 0 0-3.2 0Z' }),
    React.createElement('circle', { cx: 12, cy: 13.9, r: 5.6, fill: 'currentColor' }),
  );
}

Object.assign(window, { Icon, KettlebellMark, GX_ICON_PATHS });
